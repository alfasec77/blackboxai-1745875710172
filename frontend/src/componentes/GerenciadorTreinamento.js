...
function GerenciadorTreinamento() {
  ...
  const iniciarTreinamento = async () => {
    ...
    setResposta(null);
    try {
      const res = await axios.post('http://localhost:8000/api/treinamento/iniciar', {
        modelo,
  ...
  return (
    <div className="p-4 max-w-xl mx-auto">
      <h2 className="text-xl font-bold mb-4">Gerenciador de Treinamento</h2>
      <div className="mb-4">
...
export default GerenciadorTreinamento;
